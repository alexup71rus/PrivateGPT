...
1. **Модель для саммаризации** (используется для постоянной памяти и генерации заголовков)
2. **Модель для RAG** (используется для постоянной памяти)
3. **Модель для генерации изображений**
